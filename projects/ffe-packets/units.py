...
class Units:
    ...
    def __init__(self, conf):
        ...
        conf.gammarad = 0.0 #NOTE: manually set to 0
        if conf.gammarad == 0.0:
            self.gammarad = 0.0
        else:
            self.gammarad = conf.gammarad
        ...
        self.l0 = conf.Nx*conf.NxMesh*conf.ell/conf.c_omp  
        ...
        #radiation 
        #if conf.gammarad == 0.0:
        #    conf.drag_amplitude = 0.0

        #self.norm_rad = conf.cfl*conf.drag_amplitude
        #self.norm_rad *= 1.0/conf.interval #time step 
        #self.norm_rad *= conf.cfl**2  #FIXME what factor is this?

        #self.norm_rad *= self.n_prtcls/self.n_test_prtcls #re-weight each test particle
