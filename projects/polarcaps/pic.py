"""
An unfinished example for pulsar polar cap particle-in-cell simulation, so far based on particle-in-cell simulation of a decaying kinetic turbulence using runko with the possibility of adding boundary conditions.
"""
...
if __name__ == "__main__":
    ...
    config.boundary_condition = "star"
    config.boundary_value_b = 10.0    
    config.m0 = 1
    config.m1 = 1
    ...
    def pic_simulation_step(x):
        ...
        ##############
        tile.boundary_condition_b(config.boundary_value_b)
        ##############        
