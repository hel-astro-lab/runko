...
#include "core/vlv/amr/integrate.h"
...
*/
class PlasmaBlock {
  using T = toolbox::Mesh< toolbox::AdaptiveMesh<float,3>, 3>;
  ...
  virtual public emf::Tile<D>
{
  ...
  /// temporary current
  toolbox::Mesh<float, 3> jx1;
  toolbox::Mesh<float, 3> jy1;
  toolbox::Mesh<float, 3> jz1;
