...
# create palette
ffmpeg -pattern_type glob -i 'node_0_*.png' -vf palettegen palette.png
ffmpeg -pattern_type glob -i 'node_0_*.png' -i palette.png -lavfi "paletteuse,setpts=6*PTS" -y out.gif
