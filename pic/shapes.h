...
inline void W3rd(double d, double* coeff){
  ...
  coeff[0] = ( 1.0 - d3 )/6.0 - 0.5*( d-d2 ); // W3_im1  (1-d^3)/6 - (d-d^3)/2
  coeff[1] = 2.0/3.0 - d2 + 0.5*d3;           // W3_i    2/3 - d^2 + d^3/2
  coeff[2] = 1.0/6.0 + 0.5*( d+d2-d3 );       // W3_ip1  1/6 - (d + d^2 - d^3)/2
  coeff[3] = d3/6.0;                          // W3_ip2  d^3/6
