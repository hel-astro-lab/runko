...
pypic.o: ${DEPS_COMMON} python/pypic.c++ pic/cell.h pic/particle.h pic/pusher.h pic/field_interpolator.h pic/communicate.h pic/current_deposit.h pic/filters.h
