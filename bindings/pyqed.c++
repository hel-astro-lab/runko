...
auto declare_pairing(py::module& m)
{
  return py::class_<qed::Pairing<D> >(m, "Pairing")
    ...
    .def_readonly("hist_nbin",            &qed::Pairing<D>::hist_nbin)
    .def_readonly("hist_nmu",             &qed::Pairing<D>::hist_nmu)
    ...
    .def("inject_photons",                &qed::Pairing<D>::inject_photons)
    ...
    .def("get_hist_mu_edges", [](qed::Pairing<D>& s) { return s.hist_mu_edges.toVector(); })
...
void bind_qed(py::module& m_sub)
{
  ...
  py::class_<qed::PairingAll2All<3> >(m_3d, "PairingAll2All")
    ...
    .def_readonly("hist_nbin",    &qed::PairingAll2All<3>::hist_nbin)
    .def_readonly("hist_nmu",     &qed::PairingAll2All<3>::hist_nmu)
    ...
    .def("get_hist_mu_edges", [](qed::PairingAll2All<3>& s) { return s.hist_mu_edges.toVector(); })
