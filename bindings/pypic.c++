...
void bind_pic(py::module& m_sub)
{
  ...
  py::class_<pic::Piston<2>>(m_2d, "Piston")
    ...
    .def_readwrite("exwall",   &pic::Piston<2>::exwall)
    .def_readwrite("eywall",   &pic::Piston<2>::eywall)
    .def_readwrite("ezwall",   &pic::Piston<2>::ezwall)
    .def_readwrite("bxwall",   &pic::Piston<2>::bxwall)
    .def_readwrite("bywall",   &pic::Piston<2>::bywall)
    .def_readwrite("bzwall",   &pic::Piston<2>::bzwall)
  ...
  py::class_<pic::Piston<3>>(m_3d, "Piston")
    ...
    .def_readwrite("exwall",   &pic::Piston<3>::exwall)
    .def_readwrite("eywall",   &pic::Piston<3>::eywall)
    .def_readwrite("ezwall",   &pic::Piston<3>::ezwall)
    .def_readwrite("bxwall",   &pic::Piston<3>::bxwall)
    .def_readwrite("bywall",   &pic::Piston<3>::bywall)
    .def_readwrite("bzwall",   &pic::Piston<3>::bzwall)
