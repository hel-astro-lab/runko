...
class Timer:
    ...
    def stats(self, name):
        ...
        if t0 < 1.0e-6:
            print("--- {:.10}   time: {:8.5f} mus /  {:3d}  ({})".format(name, t0/1.0e6,  cnts, t0))
        elif 1.0e-6 < t0 < 1.0e-3:
            print("--- {:.10}   time: {:8.5f} ms  /  {:3d}  ({})".format(name, t0/1.0e3, cnts, t0))
        elif 1.0e-3 < t0:
            print("--- {:.10}   time: {:8.5f} s   /  {:3d}  ({})".format(name, t0,       cnts, t0))
