...
PYBIND11_MODULE(pyplasma, m) {
  ...
  py::class_<vlasov::VlasovCell, 
    ...
    // .def("setDt",            &vlasov::VlasovCell::setDt)
    // .def("setDs",            &vlasov::VlasovCell::setDs)
    // .def("getDt",            &vlasov::VlasovCell::getDt)
    // .def("getDx",            &vlasov::VlasovCell::getDx)
    // .def("getDy",            &vlasov::VlasovCell::getDy)
    // .def("getDz",            &vlasov::VlasovCell::getDz)
